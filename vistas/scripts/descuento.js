...
{
	var result = confirm("¿Está Seguro de quitar el descuento al público?");
  if(result){
...
{
	var result =confirm("¿Está seguro de poner al público el descuento?");
		if(result==true){
          ...
          alert("Has cancelado la publicación del descuento")
        }
}
init();
